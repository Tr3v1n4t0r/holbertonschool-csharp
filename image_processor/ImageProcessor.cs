...
/// <summary>Class for image processing methods.</summary>
class ImageProcessor
{
    /// <summary>Inverts an image.</summary>
    /// <param name="filenames">An array of filenames for images to invert.</param>
    ...
    /// <summary>Grayscales an image.</summary>
    /// <param name="filenames">An array of filenames to grayscale.</summary>
    ...
    /// <summary>Turns an image black and white.</summary>
    /// <param name="filenames">An array of filenames to convert to black and white.</param>
    ...
    /// <summary>Turns an image into a thumbnail.</summary>
    /// <param name="filenames">An array of filenames to convery into thimbnails.</param>
    ...
    /// <summary>Parallelizes file processing.</summary>
    ...
    /// <summary>Helper function to create locked bitmaps for altering images.</summary>
